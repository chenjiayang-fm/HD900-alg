...
#define version "1126-00-V1.0-20240603"
...
//     if(stAlarmNotice.enMode != 0  &&  lock == 0)
//     {
...
skip_alg:  
        ...
        { 
            ...
            // else if(stPdResult.stResults[i].classes == pdsa32::E_CLS_PALLET) //栈板
            // {
            //      u8car_cnt ++; //暂时按车的类型给
            // }     
...
toPcModel:
                ...
                {
                    apcsPdsAlgRgbPC = new pdsa32::CPdsAlg(pdsa32::E_PDSALG_TYPE_RGB_PALLET);
                    if (NULL == apcsPdsAlgRgbPC)
                    {
                        print_level(SV_ERROR, "new pdsa32::CPdsAlg failed. [err=%d]\n", s32Ret);
                        return SV_FAILURE;
