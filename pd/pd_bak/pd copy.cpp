...
#define PD_MODEL_FLOWNET_PRE  "/root/model/flownet_pre.rknn"        /*光流模型*/
...
sint32 PD_Init(PD_CFG_PARAM_S *pstInitParam)
{
    ...
    pdsa32::CPdsAlg *apcsPdsAlgFlownet = NULL;
   ...
   // Area_Info_init();
    ...
    for (i = 0; i < m_stPdInfo.u32ChnNum; i++)
    {
        ...
        apstPdsParam[i]->enPdsModel = E_PDS_FLOWNET; //这里配置检测
...
toPcModel:
            ...
            case E_PDS_SSR:
                ...
                break;
            case E_PDS_FLOWNET:
                apcsPdsAlgFlownet = new pdsa32::CPdsAlg(pdsa32::E_PDSALG_TYPE_FLOWNET);
                if (NULL == apcsPdsAlgFlownet)
                {
                    print_level(SV_ERROR, "new pdsa32::CPdsAlg failed. [err=%d]\n", s32Ret);
                    return SV_FAILURE;
                }
                
                s32Ret = apcsPdsAlgFlownet->AlgInit(pszModelFileList, stAlgParam, pd_CheckCallback);
                if (0 != s32Ret)
                {
                    print_level(SV_ERROR, "csPdsAlg.AlgInit failed. [err=%d]\n", s32Ret);
                    return SV_FAILURE;
                ...
                m_stPdInfo.apcsPdsAlg[i] = apcsPdsAlgFlownet;
                break;
            default:
...
sint32 pd_model_file(EPdsModel pdsmodel, char **modefilelist)
{
    ...
    switch(pdsmodel)
    {
        ...
        case E_PDS_IR_PC:
            ...
            break;
        case E_PDS_FLOWNET:
            modefilelist[0] = PD_MODEL_FLOWNET_PRE;
            break;
        default:
