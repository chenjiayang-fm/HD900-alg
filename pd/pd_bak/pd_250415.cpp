...
/* PD算法驱动线程 */
opticalflowanalyzeralg::COpticalFlowAnalyzer cPalletAnalyzer;
...
// #endif
        ...
        {
            std::cout<<"bLampSwitch:" << stPalletDetectResult.bLampSwitch << std::endl; 
            std::cout<<"bDetectPallet:" << stPalletDetectResult.bDetectPallet << std::endl; 
...
sint32 PD_Init(PD_CFG_PARAM_S *pstInitParam)
{
   ...
   // Area_Info_init();
    ...
    s32Ret = cPalletAnalyzer.ImportParams("/root/config/PalletConfig.ini");
    if(s32Ret != SV_SUCCESS)
    {
