...
#define version "1126-00-V1.1-20240912"
...
void coordinate_remap(Algo_Result *stAlgResult_t,  Algo_Result_f stPdResult_t,uint8 Displaymode_t,uint32_t panel_width, uint32_t panel_height)
{
   ...
   switch (Displaymode_t)
   {
    ...
    else
    {
        if(stAlgResult_t->x2 >= 500)
        {
            stAlgResult_t->x2 = 500;
            stAlgResult_t->x1 = stAlgResult_t->x2 - 20;
        }
        if(stAlgResult_t->x1 <= 121 && stAlgResult_t->y1 < 90)
        {
            stAlgResult_t->x1 = 122;
            stAlgResult_t->y1 = 90;
        }
    }
    ...
    if(BsdRange_TYPE == 0)
    {
        if(stAlgResult_t->x1 <= (114+panel_width/2) && stAlgResult_t->y1 <80)
        {
            stAlgResult_t->x1 = (114+panel_width/2);
            stAlgResult_t->y1 = 51;
        }
    ...
    {
        if(stAlgResult_t->x1 <= (114+panel_width/2) && stAlgResult_t->y1 < 90)
        {
            stAlgResult_t->x1 = (114+panel_width/2);
            stAlgResult_t->y1 = 90;
        }
        ...
        {
            stAlgResult_t->x1 = stAlgResult_t->x1 - (stAlgResult_t->x2 - (panel_width-53));
            stAlgResult_t->x2 = (panel_width-53);
            stAlgResult_t->y2 = 59;
        }   
    }

        if(stAlgResult_t->x1 <= 530)
        {
            stAlgResult_t->x1 = 530;
    ...
    else
    {
        if(stAlgResult_t->x2 >= 500)
        {
            stAlgResult_t->x1 = stAlgResult_t->x1 - (stAlgResult_t->x2 - 500);
            stAlgResult_t->x2 = 500;
        }
        if(stAlgResult_t->x1 <= 114 && stAlgResult_t->y1 < (58+panel_height/2))
        {
            stAlgResult_t->x1 = 114;
    ...
    case DISPLAY_QUAD4:
        ...
        if(stAlgResult_t->x1 <=  (114+panel_width/2) && stAlgResult_t->y1 < (58+panel_height/2))
        {
            stAlgResult_t->x1 = (114+panel_width/2);
            stAlgResult_t->y1 = (59+panel_height/2);
        }
